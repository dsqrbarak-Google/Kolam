...
async def upload_audio(file: UploadFile = File(...)):
    ...
    try:
        ...
        prompt = (
            "תמלל את השמע בעברית בצורה מדויקת ככל הניתן ומילה במילה (Verbatim). "
            "שמור על הניסוח, הסגנון המקורי וקולו של המספר. אל תשנה את המילים, "
            "אל תשכתב ספרותית ואל תוסיף דבר. הסר רק גמגומים או מילות קישור חוזרות "
            "כמו 'אממ' או 'אה'. פלוט אך ורק את הטקסט המתומלל ללא שום תוספת."
        )
